...
# обработчика уже отвечает мгновенно. Увеличиваем пул — дёшево (это просто
# больше потоков ожидания сети, не нагрузка на CPU) и снимает эту причину
# практически полностью для нашего масштаба.
